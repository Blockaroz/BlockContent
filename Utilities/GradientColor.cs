...
public struct GradientColor
{
    ...
    public GradientColor(Color[] colors, float totalTime = 1, float fadeSpeed = 1, float progress = 0)
    {
        _color = colors;
    ...
    public Color Value
    {
        get
        {
            ...
            return Color.Lerp(_color[index], _color[(index + 1) % _color.Length], t + _progress);
        }
    }
}
