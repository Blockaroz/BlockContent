...
namespace BlockContent.Content.Particles
{
    public class HeavenSpark : Particle
    {
        ...
        public override void OnSpawn()
        {
            ...
            rotation = Main.rand.NextFloat(-1f, 1f) * 0.07f;
        }

        public override void Update()
        {
            internalScale *= 0.982f;
            velocity *= 0.9f;
            if (Main.rand.NextBool(4))
                velocity += Main.rand.NextVector2Circular(0.4f, 0.3f);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            bloomColor.A = 0;
            Color shineColor = Color.Lerp(color, Color.White, color.ToVector4().Length() / 2f * internalScale) * Utils.GetLerpValue(0.1f, 0.5f, scale, true);
            shineColor.A = 0;
            ...
            spriteBatch.Draw(bloom.Value, position - Main.screenPosition, null, bloomColor * 0.12f, rotation, bloom.Size() * 0.5f, realScale * 1.5f, SpriteEffects.None, 0);
            spriteBatch.Draw(star.Value, position - Main.screenPosition, null, shineColor, rotation, star.Size() * 0.5f, realScale * 0.4f, SpriteEffects.None, 0);
